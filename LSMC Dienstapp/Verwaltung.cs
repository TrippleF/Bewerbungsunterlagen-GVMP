...
namespace LSMC_Dienstapp
{
    public partial class Verwaltung : Form
    {
        ...
        private void rankUpBedinungenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            BedinungenRankup x = new BedinungenRankup();
            x.Show();
        }

        private void motdÄndernToolStripMenuItem_Click(object sender, EventArgs e)
        {
            modt f = new modt();
            f.Show();
        }
